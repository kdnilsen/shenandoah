...
#ifdef ASSERT
bool validate_shenandoah_displaced_mark_helper(Thread *t) {
  return (!t->is_VM_thread() || ShenandoahSafepoint::is_at_shenandoah_safepoint() ||
          ShenandoahThreadLocalData::thread_is_marked_as_suspendible(t));
}
#endif
